...
export const FONT_CATALOG: CatalogFont[] = [
  ...
  {
    family: 'Noto Sans Thai', label: 'Noto Sans Thai', builtIn: false, category: 'thai', sampleText: 'สวัสดี Aa',
    variable: true,
    githubUrls: { 400: `${GH}/ofl/notosansthai/NotoSansThai%5Bwdth%2Cwght%5D.ttf` },
  },
  {
    family: 'Noto Serif Thai', label: 'Noto Serif Thai', builtIn: false, category: 'thai', sampleText: 'สวัสดี Aa',
    variable: true,
    githubUrls: { 400: `${GH}/ofl/notoserifthai/NotoSerifThai%5Bwdth%2Cwght%5D.ttf` },
  },
  {
    family: 'IBM Plex Sans Thai', label: 'IBM Plex Sans Thai', builtIn: false, category: 'thai', sampleText: 'สวัสดี Aa',
    githubUrls: {
  ...
  {
    family: 'Prompt', label: 'Prompt', builtIn: false, category: 'thai', sampleText: 'สวัสดี Aa',
    githubUrls: {
  ...
  {
    family: 'Kanit', label: 'Kanit', builtIn: false, category: 'thai', sampleText: 'สวัสดี Aa',
    githubUrls: {
  ...
  {
    family: 'Mitr', label: 'Mitr', builtIn: false, category: 'thai', sampleText: 'สวัสดี Aa',
    githubUrls: {
  ...
  {
    family: 'Chakra Petch', label: 'Chakra Petch', builtIn: false, category: 'thai', sampleText: 'สวัสดี Aa',
    githubUrls: {
  ...
  {
    family: 'Chonburi', label: 'Chonburi (Display)', builtIn: false, category: 'thai', sampleText: 'สวัสดี Aa',
    githubUrls: { 400: `${GH}/ofl/chonburi/Chonburi-Regular.ttf` },
  },

  // === Latin fonts ===
  {
    family: 'Inter', label: 'Inter', builtIn: false, category: 'latin', sampleText: 'The quick brown fox',
    variable: true,
    githubUrls: { 400: `${GH}/ofl/inter/Inter%5Bopsz%2Cwght%5D.ttf` },
  },
  {
    family: 'Roboto', label: 'Roboto', builtIn: false, category: 'latin', sampleText: 'The quick brown fox',
    variable: true,
    githubUrls: { 400: `${GH}/ofl/roboto/Roboto%5Bwdth%2Cwght%5D.ttf` },
  },
  {
    family: 'Open Sans', label: 'Open Sans', builtIn: false, category: 'latin', sampleText: 'The quick brown fox',
    variable: true,
    githubUrls: { 400: `${GH}/ofl/opensans/OpenSans%5Bwdth%2Cwght%5D.ttf` },
  },
  {
    family: 'Lato', label: 'Lato', builtIn: false, category: 'latin', sampleText: 'The quick brown fox',
    githubUrls: {
  ...
  {
    family: 'Playfair Display', label: 'Playfair Display', builtIn: false, category: 'latin', sampleText: 'Elegant Serif',
    variable: true,
  ...
  // === Monospace fonts ===
  {
    family: 'Noto Sans Mono', label: 'Noto Sans Mono', builtIn: false, category: 'mono', sampleText: 'code { }',
    variable: true,
    githubUrls: { 400: `${GH}/ofl/notosansmono/NotoSansMono%5Bwdth%2Cwght%5D.ttf` },
  },
  {
    family: 'JetBrains Mono', label: 'JetBrains Mono', builtIn: false, category: 'mono', sampleText: 'code { }',
    variable: true,
    githubUrls: { 400: `${GH}/ofl/jetbrainsmono/JetBrainsMono%5Bwght%5D.ttf` },
  },
  {
    family: 'Fira Code', label: 'Fira Code', builtIn: false, category: 'mono', sampleText: 'code { }',
    variable: true,
