 ...
 */
export function getPaperWidth(size: string, orientation: string = 'portrait'): number {
 ...
 */
export function getPaperHeight(size: string, orientation: string = 'portrait'): number {
