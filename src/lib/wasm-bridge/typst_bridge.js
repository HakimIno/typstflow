/* @ts-self-types="./typst_bridge.d.ts" */
...
export class LayoutEngine {
     ...
     * @returns {any}
     */
    find_snaps(id, x, y, width, height, threshold, zone_filter) {
        ...
        const ret = wasm.layoutengine_find_snaps(this.__wbg_ptr, ptr0, len0, x, y, width, height, threshold, ptr1, len1);
        if (ret[2]) {
     ...
     */
    insert_node(input) {
        const ret = wasm.layoutengine_insert_node(this.__wbg_ptr, input);
        if (ret[1]) {
     ...
     * @param {any} inputs
     */
    insert_nodes_batch(inputs) {
        const ret = wasm.layoutengine_insert_nodes_batch(this.__wbg_ptr, inputs);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
export class TableEngine {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        TableEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_tableengine_free(ptr, 0);
    }
    /**
     * @param {string} table_json
     * @param {number} page_height_mm
     * @param {number} start_y_mm
     * @returns {any}
     */
    static resolve(table_json, page_height_mm, start_y_mm) {
        const ptr0 = passStringToWasm0(table_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.tableengine_resolve(ptr0, len0, page_height_mm, start_y_mm);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
if (Symbol.dispose) TableEngine.prototype[Symbol.dispose] = TableEngine.prototype.free;

export class TypstBridge {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        TypstBridgeFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
     ...
     * @returns {string}
     */
    generate_report_typst(schema_json, data_json) {
        let deferred4_0;
        let deferred4_1;
        try {
            ...
            const ret = wasm.typstbridge_generate_report_typst(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
     ...
     * @returns {Uint8Array}
     */
    render_report_pdf(schema_json, data_json) {
        const ptr0 = passStringToWasm0(schema_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(data_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.typstbridge_render_report_pdf(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
     ...
     * @returns {string}
     */
    render_report_svg(schema_json, data_json) {
        let deferred4_0;
        let deferred4_1;
        try {
            const ptr0 = passStringToWasm0(schema_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            ...
            const ptr1 = passStringToWasm0(data_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.typstbridge_render_report_svg(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
    ...
    render_svg(source_code) {
        ...
        try {
            const ptr0 = passStringToWasm0(source_code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.typstbridge_render_svg(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
...
const TypstBridgeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_typstbridge_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('typst_bridge_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
