...
export const ShareModal = memo(function ShareModal({ isOpen, onClose }: ShareModalProps) {
  ...
  return (
    <Modal open={isOpen} zIndexClassName="z-50" className="p-6">
      <ModalHeader
      ...
      {status === 'done' && shareUrl && (
        <>
          <p className="text-xs text-[var(--text-muted)] mb-3">Share this link:</p>
          <div className="flex items-center gap-2 bg-[var(--bg-widget)] border border-[var(--border-default)] rounded-lg px-3 py-2 mb-4">
